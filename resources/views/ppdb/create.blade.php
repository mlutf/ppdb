  ...
  <body>
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="mb-5">
                <a href="{{url('register')}}" class="btn btn-success">Kembali</a>
            </div>
            <div class="card">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <textarea name="alamat" id=""  class="form-control" cols="5" rows="5"  required></textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="asalsmp" class="form-control" placeholder="Asal Sekolah"  required>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                <div class="form-group">
